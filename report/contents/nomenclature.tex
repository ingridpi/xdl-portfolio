...
\nomenclature[B, 10]{$\mathbb{A}\subset\mathbb{B}$}{Set $\mathbb{A}$ is a subset of set $\mathbb{B}$}
...
\nomenclature[F, 03]{$f(x;\theta)$}{Function of $x$ with parameters $\theta$}
\nomenclature[F, 04]{$f'(x)$}{Derivative of function $f$ at $x$}
\nomenclature[F, 05]{$\int f(x) \, dx$}{Integral of function $f$}
