...
class Explainer:
    """
    Base class for explainers in the portfolio optimization environment.
    This class provides methods to build state and action spaces, split data,
    and build a proxy explanation model.
    """
